 ...
 */
final class Version20201216201419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blog (
          ...
          INDEX IDX_C0155143A76ED395 (user_id),
          PRIMARY KEY(id)
        ...
        $this->addSql('CREATE TABLE verification_request (
          ...
          user_id INT NOT NULL,
          status ENUM(
            \'approved\', \'declined\', \'verification requested\'
          ) NOT NULL COMMENT \'(DC2Type:enum_verification_request_type)\',
          image_path VARCHAR(255) NOT NULL,
          rejection_reason VARCHAR(255) DEFAULT NULL,
          initiation_message VARCHAR(255) DEFAULT NULL,
          created_at DATETIME NOT NULL,
          updated_at DATETIME NOT NULL,
          INDEX IDX_20FDDF4EA76ED395 (user_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        ADD
          CONSTRAINT FK_20FDDF4EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }

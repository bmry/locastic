 ...
 */
class getSecurity_Authentication_Provider_Guard_TokenService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'security.authentication.provider.guard.token' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.authentication.provider.guard.token'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () use ($container) {

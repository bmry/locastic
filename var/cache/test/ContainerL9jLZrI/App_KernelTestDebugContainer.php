...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\MicroserviceController' => 'getAppClientControllerService',
            'App\\Controller\\AuthorizationController' => 'getAuthorizationControllerService',
            'App\\Controller\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\Gatekeeper\\Microservices\\AddScopeControllerAction' => 'getAddScopeControllerActionService',
            'App\\Controller\\Gatekeeper\\Microservices\\RegisterMicroserviceAction' => 'getRegisterMicroserviceActionService',
            'App\\Controller\\Gatekeeper\\Registration\\RegisterUserControllerAction' => 'getRegisterAdminControllerActionService',
            'App\\Controller\\Gatekeeper\\Registration\\RegisterClientAdminControllerAction' => 'getRegisterClientAdminControllerActionService',
            'App\\Controller\\Gatekeeper\\Registration\\RegisterMSOwnerControllerAction' => 'getRegisterMSOwnerControllerActionService',
            'App\\Controller\\Gatekeeper\\Registration\\VerifyAccountControllerAction' => 'getVerifyAccountControllerActionService',
            'App\\Controller\\Gatekeeper\\Scope\\AssignScopeControllerAction' => 'getAssignScopeControllerActionService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/AuthRequestSubscriber.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\AuthRequestSubscriber'] ?? $this->getAuthRequestSubscriberService());
        }, 1 => 'onKernelRequest'], 0);
        $instance->addListener('microservice.register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\MicroserviceSubscriber'] ?? $this->load('getMicroserviceSubscriberService'));
        }, 1 => 'onMicroserviceRegister'], 0);
        $instance->addListener('ms_owner.register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RegistrationSubscriber'] ?? $this->load('getRegistrationSubscriberService'));
        }, 1 => 'onMicroserviceOwnerRegister'], 0);
        $instance->addListener('admin.register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RegistrationSubscriber'] ?? $this->load('getRegistrationSubscriberService'));
        }, 1 => 'onAdminRegister'], 0);
        $instance->addListener('client_admin.register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RegistrationSubscriber'] ?? $this->load('getRegistrationSubscriberService'));
        }, 1 => 'onClientAdminRegister'], 0);
        $instance->addListener('user.verify', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\UserVerificationSubscriber'] ?? $this->load('getUserVerificationSubscriberService'));
        }, 1 => 'onVerifyMicroserviceOwnerUser'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\AuthRequestSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\AuthRequestSubscriber
     */
    protected function getAuthRequestSubscriberService()
    {
        return $this->privates['App\\EventSubscriber\\AuthRequestSubscriber'] = new \App\EventSubscriber\AuthRequestSubscriber(($this->services['session'] ?? $this->getSessionService()));
    }
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CodeVerifierRepository' => ['privates', 'App\\Repository\\CodeVerifierRepository', 'getCodeVerifierRepositoryService', true],
            'App\\Repository\\MicroserviceRepository' => ['privates', 'App\\Repository\\MicroserviceRepository', 'getMicroserviceRepositoryService', true],
            'App\\Repository\\MicroserviceScopeRepository' => ['privates', 'App\\Repository\\MicroserviceScopeRepository', 'getMicroserviceScopeRepositoryService', true],
            'App\\Repository\\UserAuthorizedAppRepository' => ['privates', 'App\\Repository\\UserAuthorizedAppRepository', 'getUserAuthorizedAppRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\CodeVerifierRepository' => '?',
            'App\\Repository\\MicroserviceRepository' => '?',
            'App\\Repository\\MicroserviceScopeRepository' => '?',
            'App\\Repository\\UserAuthorizedAppRepository' => '?',
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.token'] ?? $this->load('getSecurity_Authentication_Provider_Guard_TokenService'));
            yield 1 => ($this->privates['security.authentication.provider.anonymous.token'] ?? ($this->privates['security.authentication.provider.anonymous.token'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            ...
            yield 4 => ($this->privates['security.authentication.provider.guard.main'] ?? $this->load('getSecurity_Authentication_Provider_Guard_MainService'));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.token' => ['privates', 'security.firewall.map.context.token', 'getSecurity_Firewall_Map_Context_TokenService', true],
        ], [
            ...
            yield 'security.firewall.map.context.token' => ($this->privates['.security.request_matcher.c1hP0KI'] ?? ($this->privates['.security.request_matcher.c1hP0KI'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/auth')));

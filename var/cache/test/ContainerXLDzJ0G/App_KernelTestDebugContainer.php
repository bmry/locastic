...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Locastic\\User\\RegisterUserControllerAction' => 'getRegisterUserControllerActionService',
            'App\\Controller\\Locastic\\VerificationRequest\\ApproveVerificationRequestAction' => 'getApproveVerificationRequestActionService',
            'App\\Controller\\Locastic\\VerificationRequest\\DeclineVerificationRequestAction' => 'getDeclineVerificationRequestActionService',
            'App\\Controller\\Locastic\\VerificationRequest\\InitiateVerificationRequestAction' => 'getInitiateVerificationRequestActionService',
            'App\\Controller\\Locastic\\VerificationRequest\\UpdateVerificationRequestAction' => 'getUpdateVerificationRequestActionService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/HashPasswordSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/stof/doctrine-extensions-bundle/EventListener/BlameListener.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('verification_request.approve', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\ApproveVerificationRequestSubscriber'] ?? $this->load('getApproveVerificationRequestSubscriberService'));
        }, 1 => 'onApproveVerificationRequest'], 0);
        $instance->addListener('verification_request.decline', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\DeclineVerificationRequestSubscriber'] ?? $this->load('getDeclineVerificationRequestSubscriberService'));
        }, 1 => 'onDeclineVerificationRequest'], 0);
        $instance->addListener('verification_request.initiate', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\InitiateVerificationRequestSubscriber'] ?? $this->load('getInitiateVerificationRequestSubscriberService'));
        }, 1 => 'onInitializeVerificationRequest'], 0);
        $instance->addListener('user.register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RegistrationSubscriber'] ?? $this->load('getRegistrationSubscriberService'));
        }, 1 => 'onRegister'], 0);
        $instance->addListener('verification_request.update', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\VerificationRequestUpdateSubscriber'] ?? $this->load('getVerificationRequestUpdateSubscriberService'));
        }, 1 => 'onUpdateVerificationRequest'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\HashPasswordSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\HashPasswordSubscriber
     */
    protected function getHashPasswordSubscriberService()
    {
        return $this->privates['App\\EventSubscriber\\HashPasswordSubscriber'] = new \App\EventSubscriber\HashPasswordSubscriber(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    /**
     * Gets the private 'Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter' shared autowired service.
     *
     * @return \Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter
     */
    protected function getCamelCaseToSnakeCaseNameConverterService()
    {
        return $this->privates['Symfony\\Component\\Serializer\\NameConverter\\CamelCaseToSnakeCaseNameConverter'] = new \Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter();
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7gghH67QD1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HkTPzNx3OA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DXrYBXDI10', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J+MS-LYFro', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GChedMIv-U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityVerificationRequestApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityVerificationRequestApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_verification_request_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Cbqob2Pl9D', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iy0uXfxVvO', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CBBjBdfTna', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BmnIfYaOa8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iCkabVJ73i', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nPaueGUa2Z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ufKVAn3Z4e', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_ApiPlatform_DataPersister_InnerService()
    {
        return $this->privates['debug.api_platform.data_persister.inner'] = new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\DataPersister\\BlogDataPersister'] ?? $this->load('getBlogDataPersisterService'));
        }, 1));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        $this->privates['doctrine.dbal.default_connection.event_manager'] = $instance = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Listener\\VerificationRequestImageLinkListener' => ['privates', 'App\\Listener\\VerificationRequestImageLinkListener', 'getVerificationRequestImageLinkListenerService', true],
        ...
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.clean.media_object'] ?? $this->getVichUploader_Listener_Clean_MediaObjectService()));
        $instance->addEventSubscriber(($this->privates['App\\EventSubscriber\\HashPasswordSubscriber'] ?? $this->getHashPasswordSubscriberService()));
        ...
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.remove.media_object'] ?? $this->getVichUploader_Listener_Remove_MediaObjectService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.upload.media_object'] ?? $this->getVichUploader_Listener_Upload_MediaObjectService()));
        $instance->addEventListener([0 => 'postLoad'], 'App\\Listener\\VerificationRequestImageLinkListener');
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\VerificationRequestRepository' => ['privates', 'App\\Repository\\VerificationRequestRepository', 'getVerificationRequestRepositoryService', true],
        ], [
            'App\\Repository\\BlogRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\VerificationRequestRepository' => '?',
        ]));
    }
    ...
    {
        return $this->privates['serializer.name_converter.metadata_aware'] = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter(($this->privates['serializer.mapping.cache_class_metadata_factory'] ?? $this->getSerializer_Mapping_CacheClassMetadataFactoryService()), ($this->privates['Symfony\\Component\\Serializer\\NameConverter\\CamelCaseToSnakeCaseNameConverter'] ?? ($this->privates['Symfony\\Component\\Serializer\\NameConverter\\CamelCaseToSnakeCaseNameConverter'] = new \Symfony\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter())));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'email_sender_address': $value = $this->getEnv('EMAIL_SENDER_ADDRESS'); break;
            case 'email_sender_name': $value = $this->getEnv('EMAIL_SENDER_NAME'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'image_dir' => (\dirname(__DIR__, 4).'/public/upload/image'),
            ...
            'doctrine.dbal.connection_factory.types' => [
                'enum_verification_request_type' => [
                    'class' => 'App\\Entity\\Enum\\EnumVerificationRequestStatusType',
                ],
            ],

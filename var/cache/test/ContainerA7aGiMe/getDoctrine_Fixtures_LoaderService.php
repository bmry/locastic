...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BlogFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/VerificationRequestFixture.php';
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\AppFixtures'] ?? ($container->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\BlogFixture'] ?? ($container->privates['App\\DataFixtures\\BlogFixture'] = new \App\DataFixtures\BlogFixture())), 'groups' => []], 2 => ['fixture' => ($container->privates['App\\DataFixtures\\UserFixture'] ?? $container->load('getUserFixtureService')), 'groups' => []], 3 => ['fixture' => ($container->privates['App\\DataFixtures\\VerificationRequestFixture'] ?? ($container->privates['App\\DataFixtures\\VerificationRequestFixture'] = new \App\DataFixtures\VerificationRequestFixture())), 'groups' => []]]);

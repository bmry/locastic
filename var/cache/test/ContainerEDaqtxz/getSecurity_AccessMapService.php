...
class getSecurity_AccessMapService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/gk_register_ms_owner'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/gk_verify_account'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);

...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\EventSubscriber\\AuthRequestSubscriber' => ['privates', 'App\\EventSubscriber\\AuthRequestSubscriber', 'getAuthRequestSubscriberService', false],
            'App\\EventSubscriber\\MicroserviceSubscriber' => ['privates', 'App\\EventSubscriber\\MicroserviceSubscriber', 'getMicroserviceSubscriberService', true],
            'App\\EventSubscriber\\RegistrationSubscriber' => ['privates', 'App\\EventSubscriber\\RegistrationSubscriber', 'getRegistrationSubscriberService', true],
            'App\\EventSubscriber\\UserVerificationSubscriber' => ['privates', 'App\\EventSubscriber\\UserVerificationSubscriber', 'getUserVerificationSubscriberService', true],
            'App\\Factory\\MicroserviceScopeFactory' => ['privates', 'App\\Factory\\MicroserviceScopeFactory', 'getMicroserviceScopeFactoryService', true],
            'App\\Form\\AppClientType' => ['privates', 'App\\Form\\AppClientType', 'getAppClientTypeService', true],
            'App\\Form\\AuthorizationFormType' => ['privates', 'App\\Form\\AuthorizationFormType', 'getAuthorizationFormTypeService', true],
            'App\\Form\\BaseURIType' => ['privates', 'App\\Form\\BaseURIType', 'getBaseURITypeService', true],
            'App\\Form\\LoginRedirectFormType' => ['privates', 'App\\Form\\LoginRedirectFormType', 'getLoginRedirectFormTypeService', true],
            'App\\Form\\LogoutRedirectFormType' => ['privates', 'App\\Form\\LogoutRedirectFormType', 'getLogoutRedirectFormTypeService', true],
            'App\\Form\\RegistrationFormType' => ['privates', 'App\\Form\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Model\\Registration\\Registration' => ['privates', 'App\\Model\\Registration\\Registration', 'getRegistrationService', true],
            'App\\Model\\Scope' => ['privates', 'App\\Model\\Scope', 'getScopeService', true],
            ...
            'App\\Security\\ApiGuardAuthenticator' => ['privates', 'App\\Security\\ApiGuardAuthenticator', 'getApiGuardAuthenticatorService', true],
            'App\\Security\\EmailVerifier' => ['privates', 'App\\Security\\EmailVerifier', 'getEmailVerifierService', true],
            'App\\Security\\GatekeeperGuardAuthenticator' => ['privates', 'App\\Security\\GatekeeperGuardAuthenticator', 'getGatekeeperGuardAuthenticatorService', true],
            'App\\Security\\LoginFormAuthenticator' => ['privates', 'App\\Security\\LoginFormAuthenticator', 'getLoginFormAuthenticatorService', true],
            'App\\Service\\ClientGenerator' => ['privates', 'App\\Service\\ClientGenerator', 'getClientGeneratorService', true],
            'App\\Service\\GatekeeperMailer' => ['privates', 'App\\Service\\GatekeeperMailer', 'getGatekeeperMailerService', true],
            'App\\Validation\\AccessTokenValidator' => ['privates', 'App\\Validation\\AccessTokenValidator', 'getAccessTokenValidatorService', true],
            'App\\Validation\\AssignedScopeValidator' => ['privates', 'App\\Validation\\AssignedScopeValidator', 'getAssignedScopeValidatorService', true],
            'App\\Validation\\RegistrationValidator' => ['privates', 'App\\Validation\\RegistrationValidator', 'getMicroserviceOwnerRegistrationValidatorService', true],
            'App\\Validation\\MicroserviceRegistrationValidator' => ['privates', 'App\\Validation\\MicroserviceRegistrationValidator', 'getMicroserviceRegistrationValidatorService', true],
            'App\\Validation\\ScopeBodyValidator' => ['privates', 'App\\Validation\\ScopeBodyValidator', 'getScopeBodyValidatorService', true],
            ...
            'Symfony\\Component\\Serializer\\NameConverter\\CamelCaseToSnakeCaseNameConverter' => ['privates', 'Symfony\\Component\\Serializer\\NameConverter\\CamelCaseToSnakeCaseNameConverter', 'getCamelCaseToSnakeCaseNameConverterService', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.C4rouET', 'get_ServiceLocator_C4rouETService', true],
            ...
            'security.authentication.listener.anonymous.token' => ['privates', 'security.authentication.listener.anonymous.token', 'getSecurity_Authentication_Listener_Anonymous_TokenService', true],
            ...
            'security.authentication.listener.guard.token' => ['privates', 'security.authentication.listener.guard.token', 'getSecurity_Authentication_Listener_Guard_TokenService', true],
            ...
            'security.authentication.provider.anonymous.token' => ['privates', 'security.authentication.provider.anonymous.token', 'getSecurity_Authentication_Provider_Anonymous_TokenService', true],
            ...
            'security.authentication.provider.guard.token' => ['privates', 'security.authentication.provider.guard.token', 'getSecurity_Authentication_Provider_Guard_TokenService', true],
            ...
            'security.exception_listener.token' => ['privates', 'security.exception_listener.token', 'getSecurity_ExceptionListener_TokenService', true],
            ...
            'security.firewall.map.config.token' => ['privates', 'security.firewall.map.config.token', 'getSecurity_Firewall_Map_Config_TokenService', true],
            ...
            'security.user_checker.token' => ['privates', 'security.user_checker', 'getSecurity_UserCheckerService', true],
            ...
            'App\\EventSubscriber\\AuthRequestSubscriber' => '?',
            'App\\EventSubscriber\\MicroserviceSubscriber' => '?',
            'App\\EventSubscriber\\RegistrationSubscriber' => '?',
            'App\\EventSubscriber\\UserVerificationSubscriber' => '?',
            'App\\Factory\\MicroserviceScopeFactory' => '?',
            'App\\Form\\AppClientType' => '?',
            'App\\Form\\AuthorizationFormType' => '?',
            'App\\Form\\BaseURIType' => '?',
            'App\\Form\\LoginRedirectFormType' => '?',
            'App\\Form\\LogoutRedirectFormType' => '?',
            ...
            'App\\Security\\GatekeeperGuardAuthenticator' => '?',
            'App\\Security\\LoginFormAuthenticator' => '?',
            'App\\Service\\ClientGenerator' => '?',
            'App\\Service\\GatekeeperMailer' => '?',
            'App\\Validation\\AccessTokenValidator' => '?',
            'App\\Validation\\AssignedScopeValidator' => '?',
            'App\\Validation\\RegistrationValidator' => '?',
            'App\\Validation\\MicroserviceRegistrationValidator' => '?',
            'App\\Validation\\ScopeBodyValidator' => '?',
            ...
            'security.exception_listener.token' => '?',
            ...
            'security.firewall.map.config.token' => '?',

...
/* user/list.html.twig */
class __TwigTemplate_ec607d852420ed67bdbf50bc97d7cd444736e3f85e559b6a607ccc53ad11089a extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "
                    ...
                    <td>
                        <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_profile", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\" class=\"btn btn-sm btn-outline-primary\">
                            <i class=\"k-button-icon\"></i> Profile
                        </a>
...
";
    ...
    {
        return array (  110 => 30,  96 => 22,  89 => 18,  84 => 15,  80 => 14,  68 => 4,  58 => 3,  35 => 1,);
    }
        ...
        <table class=\"table responsive\">
            ...
            {% for user  in users %}
                <tr>
                    ...
                    <td>
                        <a href=\"{{ path('user_profile', {id: user.id}) }}\" class=\"btn btn-sm btn-outline-primary\">
                            <i class=\"k-button-icon\"></i> Profile
                        </a>
...
{% endblock body %}", "user/list.html.twig", "/var/www/app/templates/user/list.html.twig");
    }
}

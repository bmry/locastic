...
class __TwigTemplate_2ceecb3c39df23fce699fcf02d0785bd1fa2d7ac92819bb9e65a58cff3a7a963 extends Template
{
    private $source;
    private $macros = [];
...
<p>
    ...
    <a href=\"";
        // line 5
        echo (isset($context["verification_link"]) || array_key_exists("verification_link", $context) ? $context["verification_link"] : (function () { throw new RuntimeError('Variable "verification_link" does not exist.', 5, $this->source); })());
...
<p>
    Please confirm your email address by clicking the following link: <br><br>
    <a href=\"{{ verification_link|raw }}\">Confirm my Email</a>.

...
<html>
    ...
    <body>
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "user", [], "any", false, false, false, 17)) {
            // line 18
            echo "                      <li class=\"nav-item active\" style=\"margin-left: 1200px;\">
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["label"] => $context["messages"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 31
                echo "                <div class=\" col-md-6 alert-danger\">
                    ";
                // line 32
...
";
    ...
    {
        return array (  222 => 45,  218 => 44,  214 => 43,  209 => 40,  199 => 39,  181 => 37,  170 => 7,  160 => 6,  141 => 5,  129 => 51,  127 => 39,  124 => 38,  122 => 37,  119 => 36,  113 => 35,  104 => 32,  101 => 31,  96 => 30,  92 => 29,  86 => 25,  80 => 22,  74 => 19,  71 => 18,  69 => 17,  59 => 9,  57 => 6,  53 => 5,  47 => 1,);
    }
...
<html>
              ...
              <ul class=\"navbar-nav \">
                  {% if app.user  %}
                      <li class=\"nav-item active\" style=\"margin-left: 1200px;\">
                          <a  class=\"nav-link navbar-brand\" href=\"{{path('app_dashboard')}}\">Dashboard </a>
                      </li>
                      <li class=\"nav-item\">
                          <a  class=\"nav-link navbar-brand\" href=\"{{path('app_logout')}}\">Logout </a>
                      </li>
                {% endif %}
              </ul>
            </div>
    ...
    <div class=\"container\">
        ...
        {% block javascripts %}
            ...
            <script src=\"https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.bundle.min.js\" integrity=\"sha384-DBjhmceckmzwrnMMrjI7BvG2FmRuxQVaTfFYHgfnrdfqMhxKt445b7j3KBQLolRl\" crossorigin=\"anonymous\"></script>
            <script src=\"https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/js/bootstrap.min.js\" integrity=\"sha384-oesi62hOLfzrys4LxRF63OJCXdXDipiYWBnvTl9Y9/TRlw5xlKIEHpNyvvDShgf/\" crossorigin=\"anonymous\"></script>
            <script type=\"text/javascript\" src={{ asset('js/jquery.collection.js') }} />

...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Gatekeeper\\Auth\\AuthorizationController' => 'getAuthorizationControllerService',
            'App\\Controller\\Gatekeeper\\Auth\\GetUserInfoControllerAction' => 'getGetUserInfoControllerActionService',
            'App\\Controller\\Gatekeeper\\Auth\\TokenControllerAction' => 'getTokenControllerActionService',
            ...
            'App\\Controller\\Gatekeeper\\Scope\\ListScopeControllerAction' => 'getListScopeControllerActionService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\MicroserviceController' => 'getMicroserviceControllerService',
            'App\\Controller\\MicroserviceScopeController' => 'getMicroserviceScopeControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('register', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\RegistrationSubscriber'] ?? $this->load('getRegistrationSubscriberService'));
        }, 1 => 'onAdminRegister'], 0);
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-a2ltZ+lo9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.client'] ?? $this->load('getSecurity_Authentication_Provider_Guard_ClientService'));
            yield 1 => ($this->privates['security.authentication.provider.anonymous.client'] ?? ($this->privates['security.authentication.provider.anonymous.client'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 2 => ($this->privates['security.authentication.provider.guard.token'] ?? $this->load('getSecurity_Authentication_Provider_Guard_TokenService'));
            yield 3 => ($this->privates['security.authentication.provider.anonymous.token'] ?? ($this->privates['security.authentication.provider.anonymous.token'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            ...
            yield 6 => ($this->privates['security.authentication.provider.guard.main'] ?? $this->load('getSecurity_Authentication_Provider_Guard_MainService'));
            yield 7 => ($this->privates['security.authentication.provider.anonymous.main'] ?? ($this->privates['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 8), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.client' => ['privates', 'security.firewall.map.context.client', 'getSecurity_Firewall_Map_Context_ClientService', true],
            ...
            yield 'security.firewall.map.context.client' => ($this->privates['.security.request_matcher.K20BCAb'] ?? ($this->privates['.security.request_matcher.K20BCAb'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/token')));
